...
const icons = [
  { id: 1, Icon: Cloud, className: "text-blue-400/30  md:text-blue-400/60 w-10 h-10 top-10 left-10" },
  { id: 2, Icon: Shield, className: "text-green-400/30 md:text-green-400/60 w-10 h-10 top-2/3 left-20" },
