  ...
  const points = [
    {
      ...
      color: "#F3F7FF",
      icon: "/icons/healthcareApplications/Ai.png",
    },
    {
      title: "Scalability",
      description:
      ...
      color: "#FBF6EF",
      icon: "/icons/healthcareApplications/cloud computing.png",
    },
    {
      title: "Security",
      description:
      ...
      color: "#EEF9FE",
      icon: "/icons/about/data-leak.png",
    },
    {
      title: "Empowerment",
      description:
      ...
      color: "#F4EDFC",
      icon: "/icons/about/empowerment.png",
    },
  ];
  return (
    <Wrapper className="md:py-10 space-y-8">
      ...
      <motion.div
        ...
        className="grid grid-cols-[repeat(auto-fit,minmax(350px,_1fr))]  gap-4"
      >
        {points.map((point, index) => {
          return (
            <motion.div
              ...
              className="md:my-4 max-md:min-h-[300px] content-center rounded-md p-8 shadow-md space-y-4 max-md:sticky top-24"
            >
              <img
                className="size-16 md:size-20 mx-auto object-contain"
                src={point.icon}
                alt=""
              />
